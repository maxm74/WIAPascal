...
// *********************************************************************//
  ICommonDialog = interface(IDispatch)
    ...
    procedure ShowPhotoPrintingWizard(const Files: OleVariant); safecall;
  end;
...
// *********************************************************************//
  ICommonDialogDisp = dispinterface
    ...
    procedure ShowPhotoPrintingWizard(const Files: OleVariant); dispid 8;
  end;
...
// *********************************************************************//
  _IDeviceManagerEvents = dispinterface
    ...
    function OnEvent(const EventID: WideString; const DeviceID: WideString; const ItemID: WideString): HResult; dispid 1;
  end;
